...
CREATE TABLE service_taxonomy_resource_xref(
id int IDENTITY(1,1),
service_taxonomy_id int NOT NULL, 
resource_id int NOT NULL,

CONSTRAINT pk_servicetaxon_resource_xref PRIMARY KEY(id),
CONSTRAINT fk_service_taxon_id FOREIGN KEY (service_taxonomy_id) REFERENCES service_taxonomy(taxonomy_id),
CONSTRAINT fk_vss_resource_id_service_taxonomy FOREIGN KEY (resource_id) REFERENCES resource_program(id)
);
GO

SET QUOTED_IDENTIFIER OFF;

INSERT INTO service_taxonomy(service, taxonomy_left, taxonomy_right) 
	VALUES 
("Services",0,693),
("Food",1,18),
...
("Health & Safety",39,40),
("Pest Control",41,42),
("Housing Advice",45,50),
("Foreclosure Counseling",46,47),
("Homebuyer Education",48,49),
("Residential Housing",51,70),
("Long-Term Housing",52,61),
("Assisted Living",53,54),
("Independent Living",55,56),
("Nursing Home",57,58),
("Public Housing",59,60),
("Safe Housing",62,63),
("Short-Term Housing",64,69),
("Nursing Home",65,66),
("Sober Living",67,68),
("Goods",71,116),
("Baby Supplies",72,77),
